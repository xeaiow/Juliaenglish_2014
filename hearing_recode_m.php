    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="logout.php">登5出</a></li>
            <li><a href="http://juliaenglish.com/">回首頁</a></li>
            <li><a href="add.php">回管理主介面</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
...
<div class="row">
	<div class="col-md-12">
			<?php require 'config/dbconfig.php';
				$sql = "SELECT * FROM hearing ORDER BY id DESC";
      ...
      <?php
        while ($row = mysql_fetch_array($query)) { ?>
          <tr>
            ...
            <td><?=$row['hname']?></td>
            <td><?=$row['hcontent']?></td>
            <td><a href="hearing_recode_m_del.php?id=<?=$row['id'];?>"><button class="btn btn-danger btn-sm"><i class="fa fa-minus"></i></button></a></td>
          </tr> 
      <?php
        }
        mysql_close($link);
