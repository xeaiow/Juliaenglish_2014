...
//
$_CONFIG['calculate_space_level'] = false;
...
//
$_CONFIG['hidden_dirs'] = array("stylesheets", "samples", "javascripts");
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd", ".log.txt", "file1.php", "see.php");
...
//
$_CONFIG['users'] = array(array("julia", "english", "admin"));
