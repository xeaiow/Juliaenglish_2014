	...
	<body>
		...
		<div class="ts menu big inverted" style="margin-top:0px;">
			...
			<div class="ts item dropdown">
				...
				<div class="menu">
					<a class="item" href="pisapreaa.php">新聞閱讀搶修班</a>
			...
			<div class="right menu">
				<div class="ts item dropdown">
					...
					<div class="menu">
						<a class="item" href="vs.php">英檢 VS 多益</a>
						<a class="item" href="https://www.gept.org.tw/">GEPT 英檢中心</a>
						<a class="item" href="http://www.toeic.com.tw/">ETS 多益測驗中心</a>
						<a class="item" href="vs2.php">國中英語 VS 高中英語</a>
					</div>
				</div>
				<div class="ts item dropdown">
		    ...
		    <div class="column" style="text-align:center;">
				...
				<div class="ts flatted segment basic">
					<div class="ts two column centered grid">
						<div class="ts segment info" id="newinfo">
							<?php
							...
							?>
								<div class="ts segment basic left aligned">
									<a href="article.php?id=<?=$art_top_row['id']?>" class="article-top-title">
							...
							?>
								<div class="ts segment basic left aligned">
									<a href="article.php?id=<?=$row['id']?>" class="article-title">
					...
					<div class="ts active centered inline loader" id="loading"></div>
					<button class="ts inverted button" id="moreLoading">更多</button>
				</div>
		    </div>
		</div>
		...
		<script type="text/javascript">
			...
			$("#moreLoading").click(function(){


				$.ajax({
	                type: 'post',
	                url: '<?=$base_url?>ajax/article/moreloading.php',
	                dataType: 'json',
	                data: {
	                    page : page
	                },
	                    ...
	                    if (response.status == true) {
							...
							setTimeout(function(){
								$.each(response.result, function(i) {
									...
									$("#newinfo").append(
										'<div class="ts segment basic left aligned">' +
											'<a href="article.php?id=' + response.result[i].id + '" class="article-title">' +
												'<i class="announcement icon"></i> ' + response.result[i].title + ' <span class=\"art_time\">' + response.result[i].time + '</span>' +
											'</a>' +
										'</div>'
									);
								});
