...
<?php
	...
	*/
	...
	//
	$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd", ".log.txt");
	...
	//
	$_CONFIG['users'] = array(array("julia", "english0928584197", "admin"), array("xeee", "a9b9c8d1", "admin"));
